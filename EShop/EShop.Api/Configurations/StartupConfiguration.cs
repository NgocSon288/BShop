...
using EShop.Utilities.Options;
using EShop.ViewModels.AppUsers.Validators;
using System;
...
namespace EShop.Api.Configurations
{
    public static class StartupConfiguration
    {
        ...
        public static void IdentityConfig(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.UseSqlServer(configuration.GetConnectionString(SystemConstants.EShopConnectionString));
            });
